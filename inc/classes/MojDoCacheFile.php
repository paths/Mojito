...
require_once(MOJ_DIRECTORY_PATH_CLASSES . 'MojDoCache.php');

class MojDoCacheFile extends MojDoCache
{
    var $sPath;
     ...
     * constructor
     */
    function DoCacheFile()
    {
        parent::DoCache();

        $this->sPath = MOJ_DIRECTORY_PATH_DBCACHE;
    }
