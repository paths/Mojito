...
;(function ($, window, document, isUndefined) {
  ...
  loadButton = {
    ...
    facebook : function(self){
      ...
      $(self.element).find('.buttons').append('<div class="button facebook"><iframe src="//www.facebook.com/plugins/like.php?href='+(sett.url !== '' ? escape(sett.url) : escape(self.options.url))+'&amp;action=like&amp;send=false&amp;layout=button_count&amp;width=110&amp;show_faces=false&amp;font&amp;colorscheme=light&amp;height=21&amp;appId=270151016331206" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width: 110px; height:21px;" allowTransparency="true"></iframe></div>');
      var loading = 0;
